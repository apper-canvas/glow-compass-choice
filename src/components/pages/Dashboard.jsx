...
const activeDeals = deals.filter(deal => deal.stage_c !== "closed-won" && deal.stage_c !== "closed-lost").length;
  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <motion.div
            ...
            <Card
                ...
                <div className="flex items-center">
                    <div
                        className="w-12 h-12 bg-gradient-to-r from-primary to-blue-700 rounded-lg flex items-center justify-center mr-4">
        ...
        <motion.div
            ...
            <Card
                className="p-6 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
                <div className="flex items-center">
                    <div
                        className="w-12 h-12 bg-gradient-to-r from-accent to-yellow-500 rounded-lg flex items-center justify-center mr-4">
        ...
        <motion.div
            ...
            <Card
                ...
                <div className="flex items-center">
                    <div
                        className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg flex items-center justify-center mr-4">
        ...
        <motion.div
            ...
            <Card
                className="p-6 bg-gradient-to-br from-purple-50 to-violet-50 border-purple-200">
                <div className="flex items-center">
                    <div
                        className="w-12 h-12 bg-gradient-to-r from-purple-500 to-violet-600 rounded-lg flex items-center justify-center mr-4">
                        <ApperIcon name="DollarSign" size={24} className="text-white" />
                    </div>
                    <div>
                        <p className="text-sm font-medium text-slate-600">Total Revenue</p>
                        <p className="text-2xl font-bold text-slate-800">${metrics.totalRevenue.toLocaleString()}
                        </p>
                    </div>
                </div>
            </Card>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div
            ...
            <Card className="p-6">
                ...
                <div className="space-y-4">
                    {deals.filter(deal => deal.stage_c !== "closed-lost").sort((a, b) => b.value_c - a.value_c).slice(0, 5).map((deal, index) => {
                        const contact = contacts.find(c => c.Id === deal.contactId);

                        return (
                            <motion.div
                                key={deal.Id}
                                className="flex items-center justify-between p-4 bg-surface rounded-lg border border-slate-200 hover:border-slate-300 cursor-pointer transition-all duration-200"
                                whileHover={{
                                    scale: 1.02
                                }}>
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-slate-600 mb-2">
                                        <span
                                            className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-slate-100 text-slate-700 mr-2">
                                ...
                                <div className="text-right">
                                    <p className="text-lg font-bold text-slate-800">${deal.value_c.toLocaleString()}
                                    </p>
    ...
    <motion.div
        ...
        className="mt-8">
        <Card
            className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
            <div className="flex items-center justify-between">
                <div>
                    <h3 className="text-lg font-semibold text-slate-800 mb-2">Advanced Analytics & Reports
                                      </h3>
                    <p className="text-sm text-slate-600">View detailed insights on sales performance, conversion rates, and customer acquisition metrics
                                      </p>
                </div>
                <div className="flex items-center space-x-4">
                    ...
                    <Button
                        ...
                        <ApperIcon name="BarChart3" size={16} className="mr-2" />View Reports
                                      </Button>
                </div>
            </div>
        </Card>
